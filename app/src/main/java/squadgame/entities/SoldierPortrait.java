...
public class SoldierPortrait
    ...
    public void render(Canvas c, float screenX, float screenY) {
        ...
        if (selected) {
            ...
            c.drawRect(soldier.getX() + screenX, soldier.getY() + screenY,
                soldier.getX() + screenX + soldier.getWidth(), soldier.getY() + screenY + soldier.getWidth(),
                selectionPaint);
        }
    }
}
